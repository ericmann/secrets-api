...
- [`0009-cap-a-many-version-backend-to-two-slots.md`](decisions/0009-cap-a-many-version-backend-to-two-slots.md) — the Vault example caps `max_versions` at 2 and defines `PREVIOUS` as strictly N-1.
